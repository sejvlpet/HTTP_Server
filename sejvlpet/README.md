...
* Implementace:
    1. Pokud dostane server konfigurační soubor, pokus se jej přečíst a patřičně zpracovat
    2. Začne poslouchat podle zadaných parametrů
    3. Při přijetí requestu jej třída Worker zparsuje a Controller se zpracovaný request
    pokusí zpracovat ve vlastním vláknu - tedy vytvořit a zapsat odpověd
    4. Všechny významné události jsou logované a to bud na standardní výstup, nebo
    to souboru
